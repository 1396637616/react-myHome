				    ...
				    <Layout style={{background:'rgba(0,0,0,0)'}}>
				      <Sider width={150} style={{ background: 'rgba(0,0,0,0)' }}>
				        <Menu
				          ...
				          style={{ height: '100%', borderRight: 0,background:'rgba(0,0,0,0)' }}
				        >
				        <SubMenu key="sub4" style={{color:'red'}} title={<Link to="/welcome"><span>欢迎</span></Link>}>
				           
				        </SubMenu>
				          <SubMenu key="sub1" style={{color:'red'}} title={<span><Icon type="user" />关于我</span>}>
				            <Menu.Item style={{}} key="1"><Link to="/myself">工作经历</Link></Menu.Item>
				            <Menu.Item key="2"><Link to="/callMe">联系我</Link></Menu.Item>
				            <Menu.Item key="3"><Link to="/zone">个人主页</Link></Menu.Item>
				          
				          </SubMenu>
				          <SubMenu key="sub2" style={{color:'red'}} title={<span><Icon type="laptop" />我的足迹</span>}>
				            <Menu.Item key="5"><Link to="/zuji">足迹</Link></Menu.Item>
				            <Menu.Item key="6"><Link to="/work">工作</Link></Menu.Item>
				          
				          </SubMenu>
				          <SubMenu key="sub3" style={{color:'red'}} title={<span><Icon type="notification" />学习心得</span>}>
